  ...
  return (
    <form action={formAction} className="space-y-6">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div>
          <label className="mb-1 block text-sm text-slate-700">Nombre del equipo 1</label>
          <input
            name="teamAName"
            required
        ...
        <div>
          <label className="mb-1 block text-sm text-slate-700">Nombre del equipo 2</label>
          <input
            name="teamBName"
            required
            className="w-full rounded border border-slate-300 bg-white px-3 py-2 text-slate-900 outline-none focus:border-amber-400"
      ...
      <div className="sm:w-48">
        <label className="mb-1 block text-sm text-slate-700">Número de rondas</label>
        <input
          name="roundCount"
          type="number"
          min={1}
