  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-400">Misión Cristiana Elim · Elige un juego</p>
      </div>

      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {/* ¿Quién Quiere Ser Bendecido? */}
        <div className="space-y-5 rounded-lg border border-slate-800 bg-slate-900/50 p-5">
          <h2 className="text-xl font-bold text-amber-300">¿Quién Quiere Ser Bendecido?</h2>

          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-lg border border-slate-800 bg-slate-900 p-4">
              <p className="text-xs text-slate-400">Preguntas activas</p>
              <p className="text-2xl font-bold">{questionCount}</p>
            </div>
            <div className="rounded-lg border border-slate-800 bg-slate-900 p-4">
              <p className="text-xs text-slate-400">Partidas en curso</p>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link
              ...
              className="rounded border border-slate-700 px-3 py-2 text-sm hover:border-amber-400"
            >
              Preguntas
            </Link>
            <Link
          ...
          <div>
            <h3 className="mb-2 text-sm font-semibold text-slate-300">Partidas recientes</h3>
                ...
                {recentSessions.map((s) => (
                  <li key={s.id} className="flex items-center justify-between px-3 py-2 text-sm">
                    ...
                    <div className="flex gap-2">
                      <Link href={`/admin/sesiones/${s.id}`} className="text-amber-400 hover:underline">
                        Ver
                      </Link>
                      <Link href={`/juego/${s.id}`} className="text-amber-400 hover:underline">
                        Abrir
                      </Link>
                    </div>
                  </li>
        ...
        <div className="space-y-5 rounded-lg border border-slate-800 bg-slate-900/50 p-5">
          <h2 className="text-xl font-bold text-amber-300">100 Cristianos Dijeron</h2>
